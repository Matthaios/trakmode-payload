...
import {
  ...
  type SelectItemType,
  sizes,
} from '@/components/untitled/base/select/select'
        ...
        <>
          ...
          <div className="relative flex w-full items-center gap-2">
            {inputValue && (
              ...
              >
                <p
                  className={cn('text-md font-medium text-primary', isDisabled && 'text-disabled')}
                >
                  {first}
                </p>
                {last && (
                  <p
                    className={cn('-ml-0.75 text-md text-tertiary', isDisabled && 'text-disabled')}
                  >
                    {last}
                  </p>
                )}
