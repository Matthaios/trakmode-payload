...
import type { InputBaseProps } from '@/components/untitled/base/input/input'
...
export const InputGroup = ({
  ...
  return (
    <TextField
      ...
      inputClassName={cn(paddings[size].input)}
      ...
      {({ isDisabled, isInvalid, isRequired }) => (
        <>
          ...
          >
            ...
            {prefix && (
              <span className={cn('my-auto grow pr-2', paddings[size].leadingText)}>
                <p className={cn('text-md text-tertiary', isDisabled && 'text-disabled')}>
                  {prefix}
                </p>
              </span>
            )}
