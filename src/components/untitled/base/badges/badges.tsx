...
export const Badge = <T extends BadgeTypes>(props: BadgeProps<T>) => {
  ...
  return (
    <span
      className={cn(colors.common, sizes[type][size], colors.styles[color].root, props.className)}
    >
      {children}
    </span>
  )
...
export const BadgeWithIcon = <T extends BadgeTypes>(props: BadgeWithIconProps<T>) => {
  ...
  return (
    <span
      className={cn(colors.common, sizes[type][size][icon], colors.styles[color].root, className)}
    >
      {IconLeading && <IconLeading className={cn(colors.styles[color].addon, 'size-3 stroke-3')} />}
      {children}
      {IconTrailing && (
        <IconTrailing className={cn(colors.styles[color].addon, 'size-3 stroke-3')} />
      )}
    </span>
  )
}
...
export const BadgeIcon = <T extends BadgeTypes>(props: BadgeIconProps<T>) => {
  ...
  return (
    <span className={cn(colors.common, sizes[type][size], colors.styles[color].root)}>
      <Icon className={cn('size-3 stroke-[3px]', colors.styles[color].addon)} />
    </span>
  )
}
