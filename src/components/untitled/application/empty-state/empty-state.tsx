...
import { FeaturedIcon as FeaturedIconbase } from '@/components/untitled/foundations/featured-icon/featured-icon'
import type { BackgroundPatternProps } from '@/components/untitled/shared-assets/background-patterns'
import { BackgroundPattern } from '@/components/untitled/shared-assets/background-patterns'
import { Illustration as Illustrations } from '@/components/untitled/shared-assets/illustrations'
