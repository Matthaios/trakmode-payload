    ...
    >
      <div className="flex flex-1 flex-col gap-0.5">
        <div className="flex items-center gap-2">
          <h2 className={cn('font-semibold text-primary', size === 'sm' ? 'text-md' : 'text-lg')}>
            {title}
          </h2>
          {badge ? (
  ...
  return (
    ...
    >
      {selectionBehavior === 'toggle' && (
        <AriaColumn
          className={cn('relative py-2 pr-0 pl-4', size === 'sm' ? 'w-9 md:pl-5' : 'w-11 md:pl-6')}
        >
...
const TableRow = <T extends object>({
  ...
  return (
    ...
    >
      {selectionBehavior === 'toggle' && (
        <AriaCell className={cn('relative py-2 pr-0 pl-4', size === 'sm' ? 'md:pl-5' : 'md:pl-6')}>
