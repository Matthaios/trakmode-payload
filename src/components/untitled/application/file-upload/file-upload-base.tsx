...
import { ProgressBar } from '@/components/untitled/base/progress-indicators/progress-indicators'
import { FeaturedIcon } from '@/components/untitled/foundations/featured-icon/featured-icon'
...
export const FileListItemProgressFill = ({
  ...
  return (
    <motion.li
      layout="position"
      className={cn('relative flex gap-3 overflow-hidden rounded-xl bg-primary p-4', className)}
    >
      {/* Progress fill. */}
      <div
