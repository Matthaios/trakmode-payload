...
const SectionHeaderRoot = (props: ComponentPropsWithRef<'div'>) => (
  <div
    {...props}
    className={cn('flex flex-col gap-5 border-b border-secondary pb-5', props.className)}
  >
    {props.children}
  </div>
)
...
const SectionHeaderGroup = (props: ComponentPropsWithRef<'div'>) => (
  <div
    {...props}
    className={cn('relative flex flex-col items-start gap-4 md:flex-row', props.className)}
  >
    {props.children}
  </div>
)
...
const SectionHeaderHeading = (props: ComponentPropsWithRef<'h2'>) => (
  <h2 {...props} className={cn('text-lg font-semibold text-primary', props.className)}>
    {props.children}
  </h2>
)

const SectionHeaderSubheading = (props: ComponentPropsWithRef<'p'>) => (
  <p {...props} className={cn('text-sm text-tertiary', props.className)}>
    {props.children}
  </p>
)
