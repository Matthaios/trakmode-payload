...
export const sm = ({
  ...
  return (
    <div {...otherProps} className={cn('relative h-31.5 w-38', className)}>
      <svg
        viewBox="0 0 152 126"
        fill="none"
...
export const md = ({
  ...
  return (
    <div {...otherProps} className={cn('relative h-37 w-43', className)}>
      <svg
        viewBox="0 0 172 148"
        fill="none"
        className={cn('size-full stroke-inherit text-inherit', svgClassName)}
...
export const lg = ({
  ...
  return (
    <div {...otherProps} className={cn('relative h-45.25 w-55', className)}>
      <svg
        viewBox="0 0 220 181"
        fill="none"
        className={cn('size-full stroke-inherit text-inherit', svgClassName)}
