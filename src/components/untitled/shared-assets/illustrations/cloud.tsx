...
export const sm = ({
  ...
  return (
    <div {...otherProps} className={cn('relative h-30 w-38', className)}>
      <svg
        viewBox="0 0 152 120"
        fill="none"
...
export const md = ({
  ...
  return (
    <div {...otherProps} className={cn('relative h-32 w-43', className)}>
      <svg
        viewBox="0 0 182 137"
        fill="none"
        className={cn('size-full stroke-inherit text-inherit', svgClassName)}
...
export const lg = ({
  ...
  return (
    <div {...otherProps} className={cn('relative h-40 w-55', className)}>
      <svg
        viewBox="0 0 220 160"
        fill="none"
        className={cn('size-full stroke-inherit text-inherit', svgClassName)}
