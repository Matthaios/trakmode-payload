...
import { UntitledLogo } from '@/shared/ui/foundations/logo/untitledui-logo'
import { UntitledLogoMinimal } from '@/shared/ui/foundations/logo/untitledui-logo-minimal'
import { DropdownMenuSimple } from '@/shared/ui/marketing/header-navigation/dropdown-header-navigation'
...
const headerNavItems: HeaderNavItem[] = [{ label: 'Store', href: '/store' }]
