...
export const ButtonGroupItem = ({
  ...
  return (
    <AriaToggleButton
      ...
      className={cn(styles.common.root, styles.sizes[size].root, className)}
    >
      {isReactComponent(IconLeading) && (
        <IconLeading className={cn(styles.common.icon, styles.sizes[size].icon)} />
      )}
      ...
      {isReactComponent(IconTrailing) && (
        <IconTrailing className={cn(styles.common.icon, styles.sizes[size].icon)} />
      )}
  ...
  return (
    <ButtonGroupContext.Provider value={{ size }}>
      <AriaToggleButtonGroup
        ...
        className={cn('relative z-0 inline-flex w-max -space-x-px rounded-lg shadow-xs', className)}
        {...otherProps}
      >
        {children}
      </AriaToggleButtonGroup>
